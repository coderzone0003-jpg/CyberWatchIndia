          ...
          <div className="row align-items-center g-5">
            ...
            <div className="col-lg-5">
              <div className="hero-card p-4 shadow-lg">
                <h5 className="fw-bold mb-3">Immediate Response Channels</h5>
                <ul className="list-unstyled mb-0">
                  <li className="mb-2"><i className="bi bi-check-circle-fill text-success me-2"></i>National Cyber Helpline: 1930</li>
                  <li className="mb-2"><i className="bi bi-check-circle-fill text-success me-2"></i>Emergency Police: 112</li>
                  <li className="mb-2"><i className="bi bi-check-circle-fill text-success me-2"></i>Secure Evidence Submission</li>
                </ul>
              </div>
            </div>
          </div>
